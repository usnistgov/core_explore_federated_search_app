...
urlpatterns = [
    re_path(r'^get_data_sources', user_ajax.get_data_source_list_federated,
            name='core_explore_federated_search_app_get_data_sources'),
    re_path(r'^update_data_sources', user_ajax.update_data_source_list_federated,
            name='core_explore_federated_search_app_update_data_sources'),
    re_path(r'^data', user_views.ViewData.as_view(),
