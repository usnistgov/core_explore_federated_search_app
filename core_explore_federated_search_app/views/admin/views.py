...
def manage_repositories(request):
    ...
    modals = [
        "core_explore_federated_search_app/admin/repositories/list/modals/edit.html",
        "core_explore_federated_search_app/admin/repositories/list/modals/delete.html",
        "core_explore_federated_search_app/admin/repositories/list/modals/refresh.html"
    ]

    assets = {
        "js": [
            {
                "path": 'core_explore_federated_search_app/admin/js/repositories/list/modals/delete.js',
                "is_raw": False
            },
            {
                "path": 'core_explore_federated_search_app/admin/js/repositories/list/modals/edit.js',
                "is_raw": False
            },
            {
                "path": 'core_explore_federated_search_app/admin/js/repositories/list/modals/refresh.js',
                "is_raw": False
            }
        ]
    }
    ...
    return admin_render(request,
                        'core_explore_federated_search_app/admin/repositories/list_repositories.html',
                        assets=assets,
                        context=context,
                        modals=modals)
...
def add_repository(request):
    ...
    return admin_render(request,
                        'core_explore_federated_search_app/admin/repositories/add_repository.html',
                        assets=None,
                        context=context,
                        modals=None)
